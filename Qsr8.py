...
class crack_main():
        ...
        def pasw(self):
                ...
                if pl in ['auto','Auto','AUTO','auto or Auto']:
                        passlist.append('afghan1122')
                        passlist.append('afghan12345')
                        passlist.append('kabul1234')
                        passlist.append('afghan12')
                        passlist.append('afghanistan')
                        passlist.append('kabul223')
                        passlist.append('600700')
                        passlist.append('102030')
                        passlist.append('500500')
                        passlist.append('kabul1133')
                        passlist.append('mzar123')
                        passlist.append('123456')
                else:
...
def sep():
        ...
        y = 0
        print(f"{ro} Ids To Grabb Ex [ 9378,9370,9369 etc ]{s}")
